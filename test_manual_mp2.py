#!/usr/bin/env python3
"""Test manual message passing using PyG's scatter."""
...
class ManualMP(MessagePassing):
    ...
    def forward(self, x, ei, ea, node_volumes):
        ...
        # 4. Aggregate messages to target nodes using PyG's scatter
...
print("=" * 70)
print("Testing manual message passing using PyG's scatter:")
print("=" * 70)
